...
public final class ServiceElementFactory {
     ...
     * Create a {@link ServiceElement}.
     *
     * @param deployment The {@link sorcer.core.deploy.ServiceDeployment}, must not be {@code null}.
     *
     * @return A {@code ServiceElement}
     *
     * @throws ConfigurationException if there are problem reading the configuration
     */
    public static ServiceElement create(ServiceDeployment deployment) throws IOException, ConfigurationException, ResolverException,
            URISyntaxException {
        ...
        ServiceDetails serviceDetails = new ServiceDetails(name,
                ...
                excludeIPs,
                webster);
        ServiceElement service = create(serviceDetails, deployment, configurationFilePath);
    ...
    static ServiceElement create(final ServiceDetails serviceDetails,
        ...
        String configurationFilePath) throws IOException {
		...
		/* Create simple ServiceBeanConfig */
            ...
            ServiceBeanConfig sbc = new ServiceBeanConfig(configMap, new String[]{configurationFilePath});
