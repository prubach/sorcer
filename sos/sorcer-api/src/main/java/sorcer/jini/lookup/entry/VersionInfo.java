...
public class VersionInfo {
	...
	public static List<Entry> productAttributesFor(String serviceName) {
		final Entry info = new ServiceInfo(serviceName == null
				|| serviceName.length() == 0 ? PRODUCT_NAME : serviceName,
				VersionInfo.EMAIL_CONTACT, VersionInfo.SUPPLIER_NAME,
				VersionInfo.VERSION, MODEL, "");

		final Entry type = new com.sun.jini.lookup.entry.BasicServiceType(
				serviceName);
