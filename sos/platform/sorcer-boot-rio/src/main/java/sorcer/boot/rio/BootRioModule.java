 ...
 */
public class BootRioModule extends AbstractModule {
    @Override
    protected void configure() {
        Multibinder<IServiceDescriptorFactory> descriptorFactories = Multibinder.newSetBinder(binder().skipSources(
                OpstringServiceDescriptorFactory.class,
                OarServiceDescriptorFactory.class
