...
public class LusTree {
	...
	private static void addCodebase(URL[] codebase,
			DefaultMutableTreeNode service) {
		DefaultMutableTreeNode codebaseNode = new DefaultMutableTreeNode(
				new CodebaseNode("Codebase URLs"));

		for (int i = 0; i < codebase.length; i++) {
			codebaseNode.add(new DefaultMutableTreeNode(new CodebaseNode(
					codebase[i])));
