...
IF EXIST %LIB_DIR%\sorcer\sorcer-api.jar (
   ...
   set BOOT_CLASSPATH="%JINI_CLASSPATH%;%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\sorcer\sos-webster.jar;%LIB_DIR%\sorcer\sos-rio-start.jar;%LIB_DIR%\jini\jsk-resources.jar;%LIB_DIR%\rio\rio-platform.jar;%LIB_DIR%\rio\rio-logging-support.jar;%LIB_DIR%\rio\rio-start.jar;%LIB_DIR%\rio\rio-lib.jar;%LIB_DIR%\rio-resolver\resolver-api.jar;%LIB_DIR%\commons\groovy-all.jar;%LIB_DIR%\commons\guava.jar;%LIB_DIR%\commons\commons-lang3.jar;%LIB_DIR%\commons\commons-io.jar;%LIB_DIR%\..\configs"
   set SHELL_CLASSPATH="%JINI_BASE%;%LIB_DIR%\rio\rio-platform.jar;%LIB_DIR%\rio-resolver\resolver-api.jar;%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-shell.jar;%LIB_DIR%\sorcer\sos-netlet.jar;%LIB_DIR%\sorcer\sos-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\sorcer\sos-platform.jar;%LIB_DIR%\sorcer\sos-webster.jar;%LOG_CP%;%LIB_DIR%\commons\groovy-all.jar;%LIB_DIR%\commons\commons-io.jar;%LIB_DIR%\commons\plexus-utils.jar"
   ...
   set LOG_CP="%MVN_REPO%\org\slf4j\jul-to-slf4j\%v.slf4j%\jul-to-slf4j-%v.slf4j%.jar"
   ...
   set BOOT_CLASSPATH="%BOOT_CLASSPATH%;%MVN_REPO%\org\sorcersoft\sorcer\sos-rio-start\%v.sorcer%\sos-rio-start-%v.sorcer%.jar"
