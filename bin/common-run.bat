...
IF EXIST %LIB_DIR%\sorcer\sorcer-api.jar (
   ...
   set "BOOT_CLASSPATH=%LIB_DIR%\jini\jsk-platform.jar;%LIB_DIR%\jini\jsk-lib.jar;%LIB_DIR%\river\start.jar;%LIB_DIR%\jini-lookup\serviceui.jar;%LIB_DIR%\commons\slf4j-api.jar;%LIB_DIR%\commons\logback-classic.jar;%LIB_DIR%\commons\logback-core.jar;%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\sorcer\sos-webster.jar;%LIB_DIR%\sorcer\sos-rio-start.jar;%LIB_DIR%\jini\jsk-resources.jar;%LIB_DIR%\rio\rio-platform.jar;%LIB_DIR%\rio\rio-logging-support.jar;%LIB_DIR%\rio\rio-start.jar;%LIB_DIR%\rio\rio-lib.jar;%LIB_DIR%\rio-resolver\resolver-api.jar;%LIB_DIR%\rio\start.jar;%LIB_DIR%\commons\groovy-all.jar;%LIB_DIR%\commons\guava.jar;%LIB_DIR%\commons\commons-lang3.jar;%LIB_DIR%\commons\commons-io.jar;%LIB_DIR%\..\configs"
   rem set "SHELL_CLASSPATH=%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-shell.jar;%LIB_DIR%\sorcer\sos-netlet.jar;%LIB_DIR%\sorcer\sos-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\sorcer\sos-platform.jar;%LIB_DIR%\sorcer\sos-webster.jar;%LIB_DIR%\commons\slf4j-api.jar;%LIB_DIR%\commons\logback-core.jar;%LIB_DIR%\commons\logback-classic.jar;%LIB_DIR%\commons\groovy-all.jar;%LIB_DIR%\jini\jsk-platform.jar;%LIB_DIR%\jini\jsk-lib.jar;%LIB_DIR%\jini-lookup\serviceui.jar"
   set "SHELL_CLASSPATH=%LIB_DIR%\rio\rio-platform.jar;%LIB_DIR%\rio-resolver\resolver-api.jar;%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-shell.jar;%LIB_DIR%\sorcer\sos-netlet.jar;%LIB_DIR%\sorcer\sos-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\sorcer\sos-platform.jar;%LIB_DIR%\sorcer\sos-webster.jar;%LIB_DIR%\commons\slf4j-api.jar;%LIB_DIR%\commons\logback-core.jar;%LIB_DIR%\commons\logback-classic.jar;%LIB_DIR%\commons\groovy-all.jar;%LIB_DIR%\jini\jsk-platform.jar;%LIB_DIR%\jini\jsk-lib.jar;%LIB_DIR%\jini-lookup\serviceui.jar;%LIB_DIR%\commons\commons-io.jar;%LIB_DIR%\commons\plexus-utils.jar"
   set "SORCER_RIO_CP=%LIB_DIR%\sorcer\sorcer-api.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\sorcer\sos-rio-start.jar;%LIB_DIR%\sorcer\sos-boot.jar;%LIB_DIR%\commons\commons-lang3.jar;%LIB_DIR%\commons\guava.jar;%LIB_DIR%\jini\jsk-dl.jar"
   ...
   set "BOOT_CLASSPATH=%MVN_REPO%\net\jini\jsk-platform\%v.jini%\jsk-platform-%v.jini%.jar;%MVN_REPO%\net\jini\jsk-lib\%v.jini%\jsk-lib-%v.jini%.jar;%MVN_REPO%\org\apache\river\start\%v.jini%\start-%v.jini%.jar;%MVN_REPO%\net\jini\lookup\serviceui\%v.jini%\serviceui-%v.jini%.jar;%MVN_REPO%\org\slf4j\slf4j-api\1.7.5\slf4j-api-1.7.5.jar;%MVN_REPO%\ch\qos\logback\logback-core\1.0.11\logback-core-1.0.11.jar;%MVN_REPO%\ch\qos\logback\logback-classic\1.0.11\logback-classic-1.0.11.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-boot\%v.sorcer%\sos-boot-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sorcer-api\%v.sorcer%\sorcer-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-util\%v.sorcer%\sos-util-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-webster\%v.sorcer%\sos-webster-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-rio-start\%v.sorcer%\sos-rio-start-%v.sorcer%.jar;%MVN_REPO%\net\jini\jsk-resources\%v.jini%\jsk-resources-%v.jini%.jar;%MVN_REPO%\org\rioproject\resolver\resolver-api\%v.rio%\resolver-api-%v.rio%.jar;%MVN_REPO%\org\rioproject\rio-platform\%v.rio%\rio-platform-%v.rio%.jar;%MVN_REPO%\org\rioproject\rio-logging-support\%v.rio%\rio-logging-support-%v.rio%.jar;%MVN_REPO%\org\rioproject\rio-start\%v.rio%\rio-start-%v.rio%.jar;%MVN_REPO%\org\rioproject\rio-lib\%v.rio%\rio-lib-%v.rio%.jar;%MVN_REPO%\org\codehaus\groovy\groovy-all\%v.groovy%\groovy-all-%v.groovy%.jar;%MVN_REPO%\com\google\guava\14.0.1\guava-14.0.1.jar;%MVN_REPO%\org\apache\commons\commons-lang3\3.1\commons-lang3-3.1.jar;%MVN_REPO%\org\apache\commons\commons-io\2.4\commons-io-2,4.jar;%MVN_REPO%\com\google\collections\google-collections\1.0\google-collections-1.0.jar;%LIB_DIR%\..\configs"
   rem set "SHELL_CLASSPATH=%MVN_REPO%\org\sorcersoft\sorcer\sos-shell\%v.sorcer%\sos-shell-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sorcer-api\%v.sorcer%\sorcer-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-netlet\%v.sorcer%\sos-netlet-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-api\%v.sorcer%\sos-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-util\%v.sorcer%\sos-util-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-boot\%v.sorcer%\sos-boot-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-platform\%v.sorcer%\sos-platform-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-webster\%v.sorcer%\sos-webster-%v.sorcer%.jar;%MVN_REPO%\org\slf4j\slf4j-api\1.7.5\slf4j-api-1.7.5.jar;%MVN_REPO%\ch\qos\logback\logback-classic\1.0.11\logback-classic-1.0.11.jar;%MVN_REPO%\ch\qos\logback\logback-core\1.0.11\logback-core-1.0.11.jar;%MVN_REPO%\org\codehaus\groovy\groovy-all\%v.groovy%\groovy-all-%v.groovy%.jar;%MVN_REPO%\net\jini\jsk-platform\%v.jini%\jsk-platform-%v.jini%.jar;%MVN_REPO%\net\jini\jsk-lib\%v.jini%\jsk-lib-%v.jini%.jar;%MVN_REPO%\net\jini\lookup\serviceui\%v.jini%\serviceui-%v.jini%.jar;%MVN_REPO%\commons-io\commons-io\2.4\commons-io-2.4.jar"
   set "SHELL_CLASSPATH=%MVN_REPO%\org\rioproject\resolver\resolver-api\%v.rio%\resolver-api-%v.rio%.jar;%MVN_REPO%\org\rioproject\rio-platform\%v.rio%\rio-platform-%v.rio%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-shell\%v.sorcer%\sos-shell-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sorcer-api\%v.sorcer%\sorcer-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-netlet\%v.sorcer%\sos-netlet-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-api\%v.sorcer%\sos-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-util\%v.sorcer%\sos-util-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-boot\%v.sorcer%\sos-boot-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-platform\%v.sorcer%\sos-platform-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-webster\%v.sorcer%\sos-webster-%v.sorcer%.jar;%MVN_REPO%\org\slf4j\slf4j-api\1.7.5\slf4j-api-1.7.5.jar;%MVN_REPO%\ch\qos\logback\logback-classic\1.0.11\logback-classic-1.0.11.jar;%MVN_REPO%\org\codehaus\plexus\plexus-utils\%v.plexus%\plexus-utils-%v.plexus%.jar;%MVN_REPO%\ch\qos\logback\logback-core\1.0.11\logback-core-1.0.11.jar;%MVN_REPO%\org\codehaus\groovy\groovy-all\%v.groovy%\groovy-all-%v.groovy%.jar;%MVN_REPO%\net\jini\jsk-platform\%v.jini%\jsk-platform-%v.jini%.jar;%MVN_REPO%\net\jini\jsk-lib\%v.jini%\jsk-lib-%v.jini%.jar;%MVN_REPO%\net\jini\lookup\serviceui\%v.jini%\serviceui-%v.jini%.jar;%MVN_REPO%\commons-io\commons-io\2.4\commons-io-2.4.jar"
   set "SORCER_RIO_CP=%MVN_REPO%\org\sorcersoft\sorcer\sorcer-api\%v.sorcer%\sorcer-api-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-util\%v.sorcer%\sos-util-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-rio-start\%v.sorcer%\sos-rio-start-%v.sorcer%.jar;%MVN_REPO%\org\sorcersoft\sorcer\sos-boot\%v.sorcer%\sos-boot-%v.sorcer%.jar;%MVN_REPO%\org\apache\commons\commons-lang3\3.1\commons-lang3-3.1.jar;%MVN_REPO%\com\google\guava\guava\14.0.1\guava-14.0.1.jar;%MVN_REPO%\net\jini\jsk-dl\%v.jini%\jsk-dl-%v.jini%.jar"
   set "SORCER_RIOUI_CP=%SORCER_RIO_CP%"
)
