...
public class ParSet extends TreeSet<Par> {
	...
	public ParSet(ParList varList) {
		addAll(varList);
	}
	
	public ParSet(Set<Par> varSet) {
		addAll(varSet);
	}

	
	public ParSet(ParList...  varLists) {
		for (ParList vl : varLists) {
			addAll(vl);
		}
	}
	
	public ParSet(Par<?>[]  varArray) {
		for (Par<?> v : varArray) {
			add(v);
		}
	}
	...
	public ParList selectPars(List<String>... varnames) {
		List<String> allParNames = new ArrayList<String>();
		for (List<String> nl : varnames) {
	...
	public ParSet selectPars(String... varnames) {
		List<String> vnames = Arrays.asList(varnames);
