...
POLICY=-Djava.security.policy=/home/sobolemw/incax/browser/sorcer.policy
REQUESTOR_DATA="-Ddata.server=10.131.5.90 -Ddata.server.port=9000 -Ddata.root.dir=${SORCER_HOME}/data -Drequestor.data.dir=optimization/input"
