...
PROVIDER_NAME="fnEval"
PROVIDER_CLASS="sorcer.falcon.examples.provider.fnEval.FnEvalImpl"
...
java -Djava.security.manager= \
     ...
     -Dprovider.codebase="${JINI_DL} ${WEBSTER}/${PROVIDER_NAME}-dl.jar" \
     -Dprovider.classpath="${JINI_JARS}:${SORCER_JARS}:${SORCER_HOME}/lib/${PROVIDER_NAME}.jar" \
