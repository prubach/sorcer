...
/**
 * The IntegralWhileCondition class is an example of the Conditional component
 * for the new exertion WhileExertion. It checks when the specific Conditional
 * exertion has satisfied the condition by calling the isTrue() method.
 * 
 * @author Michael Alger
 */
public class IntegralWhileCondition implements Conditional, Serializable {
	 ...
	 * @param map Map
	 */
	public IntegralWhileCondition(String expression, Map map) {
    ...
    public void setConditionalContext(Context context) {
    	this.context = (CalcContext) context;
    }
