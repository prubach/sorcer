...
/**
 * The FnWhileCondition class is an example of the Conditional component
 ...
 */
public class DerivativeWhileCondition implements Conditional, Serializable {
	 ...
	 * @param map Map
	 */
	public DerivativeWhileCondition(String expression, Map map) {
