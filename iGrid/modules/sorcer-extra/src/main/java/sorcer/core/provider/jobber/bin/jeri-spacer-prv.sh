...
PROVIDER_NAME="spacer"
PROVIDER_CLASS="sorcer.core.provider.jobber.ServiceSpacer"

JINI_JARS="${SORCER_HOME}/common/sun-util.jar:${SORCER_HOME}/common/jini-ext.jar:${SORCER_HOME}/common/serviceui-1.1.jar:${SORCER_HOME}/common/jaxrpc.jar"
...
java -Djava.util.logging.config.file=${SORCER_HOME}/configs/sorcer.logging \
     ...
     -Dsorcer.provider.codebase="${JINI_DL} ${WEBSTER}/${PROVIDER_NAME}-dl.jar ${WEBSTER}/loki-dl.jar" \
