...
PROVIDER_NAME="caller"
PROVIDER_CLASS="sorcer.core.grid.provider.caller.CallerImpl"
...
java -Djava.security.manager= \
     ...
     -Dsorcer.provider.codebase="${JINI_DL} ${WEBSTER}/${PROVIDER_NAME}-dl.jar ${WEBSTER}/provider-ui.jar" \
