...
PROVIDER_NAME="grider"
PROVIDER_CLASS="sorcer.core.grid.provider.grider.GridDispatcherProviderImpl"

JINI_JARS="${SORCER_HOME}/common/sun-util.jar:${SORCER_HOME}/common/jini-ext.jar:${SORCER_HOME}/common/serviceui-1.1.jar:${SORCER_HOME}/common/rio.jar"
SORCER_JARS="${SORCER_HOME}/lib/sorcer.jar"
JINI_DL="${WEBSTER}/jini-ext.jar ${WEBSTER}/serviceui-1.1.jar ${WEBSTER}/sun-util.jar ${WEBSTER}/rio.jar"
...
java -Djava.security.manager= \
     ...
     -Dsorcer.provider.codebase="${JINI_DL} ${WEBSTER}/${PROVIDER_NAME}-dl.jar ${WEBSTER}/${PROVIDER_NAME}-ui.jar" \
