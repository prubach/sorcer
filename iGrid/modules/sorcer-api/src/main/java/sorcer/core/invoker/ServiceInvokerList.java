...
public class ServiceInvokerList extends ArrayList<ServiceInvoker> {

	public ServiceInvokerList() {
		super();
	}

	public ServiceInvokerList(int size) {
		super(size);
	}

	public ServiceInvokerList(Set<ServiceInvoker> invokerSet) {
		addAll(invokerSet);
	}

	public ServiceInvokerList(ServiceInvokerList... invokerLists) {
		super();
		for (ServiceInvokerList sil : invokerLists) {
			addAll(sil);
		}
	}

	public ServiceInvokerList(ServiceInvoker[] invokerArray) {
		super();
	...
	public <T> ServiceInvokerList(List<ServiceInvoker> invokerList) {
		super();
	...
	public ServiceInvokerList selectInvokers(List<String>... invokerNames) {
		List<String> allNames = new ArrayList<String>();
		for (List<String> nl : invokerNames) {
			allNames.addAll(nl);
		}
		ServiceInvokerList out = new ServiceInvokerList();
		for (ServiceInvoker si : this) {
	...
	public ServiceInvokerList selectInvokers(String... invokerNames) {
	...
	public static ServiceInvokerList asList(ServiceInvoker[] array) {
		ServiceInvokerList sil = new ServiceInvokerList(array.length);
