...
package sorcer.falcon.examples.requestor.fnEval.fnEvalIfTask;
...
public class FnEvalIfTask {
	...
	Map<String, String> map; // Map implementation for mapping variables name to
	...
	public void executeIfTask() {
		...
		Exertion task1 = createFnTask("1/x"); // task1 will evaluate the passed
		// expression
		Exertion task2 = createFnTask("x*x"); // task2 will evaluate the passed
		// expression

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("x", "in/value/var1");

		String booleanCondition = "x < 0";

		FnIfCondition condition = new FnIfCondition(booleanCondition, map);

		IfExertion ifTask = new IfExertion(condition, task1, task2); // create
		// the
		// IfExertion
		...
		try {
			...
			log.info("Condition: \"" + booleanCondition + "\"");
