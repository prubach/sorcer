...
package sorcer.falcon.examples.condition;
...
/**
 * The FnWhileCondition class is an example of the Conditional component for the
 * new exertion WhileExertion. It checks when the specific Conditional exertion
 * has satisfied the condition by calling the isTrue() method.
 * 
 * @author Michael Alger
 */
public class FnWhileCondition implements Conditional, Serializable {
	...
	/**
	 * Overloaded constructor which takes in the expression for the condition
	 * and a Map for the variable name and path reference
	 * 
	 * @param function
	 *            String
	 * @param map
	 *            Map
	 */
	public FnWhileCondition(String expression, Map map) {
	...
	/**
	 * Sets the ServiceContext of the condition for the new reference to be
	 * evaluated
	 * 
	 * @param context
	 *            ServiceContext
	...
	public void setConditionalContext(Context context) {
		this.context = (FnContext) context;
	}
