...
package sorcer.falcon.examples.requestor.fnEval.legacy.fnEvalTask;
...
public class FnEvalTask {
	...
	public static void main(String[] args) {
		...
		FnEvalTask client = new FnEvalTask();
	...
	public void executeTask() {
		...
		try {
			...
			Exertion resultTask = fnEval.service(task, null);
	...
	public NetTask createFnTask() {
		...
		try {
			...
			context.put("in/value/var1", 5);
			context.put("in/value/var2", 10);
