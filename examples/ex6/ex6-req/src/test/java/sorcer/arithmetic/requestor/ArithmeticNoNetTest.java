...
public class ArithmeticNoNetTest {
	...
	public void batchPrefixedTaskTest() throws Exception {
        ...
        Task batch3 = mkTask("batch3")
                .with(mkSig("multiply#op1", MultiplierImpl.class)
                        .returning("op3/x1", Direction.IN)
                        .with(Signature.PRE))
                .with(mkSig("add#op2", AdderImpl.class)
                        .returning("op3/x2", Direction.IN)
                        .with(Signature.PRE))
                .with(mkSig("subtract", SubtractorImpl.class)
                        .returning("result/y", from("op3/x1", "op3/x2")))
                .with(mkCtx(Context.Type.ASSOCIATIVE)
                                .in("op1/x1", 10.0)
                                .in("op1/x2", 50.0)
                                .in("op2/x1", 20.0)
                                .in("op2/x2", 80.0)
