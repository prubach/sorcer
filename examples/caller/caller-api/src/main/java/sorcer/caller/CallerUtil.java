...
public class CallerUtil {
    ...
    final static String EXEC_STARTED = "caller/started";

    final static String EXEC_STOPPED = "caller/stopped";
    ...
    public static void setStarted(Context ctx, Date startDate) throws ContextException {
        if (ctx!=null)
            ctx.putValue(EXEC_STARTED, startDate);
    }

    public static void setStopped(Context ctx, Date stoppedDate) throws ContextException {
        if (ctx!=null)
            ctx.putValue(EXEC_STOPPED, stoppedDate);
    }

    public static Date getStarted(Context ctx) throws ContextException {
        if (ctx!=null)
            return (Date)ctx.getValue(EXEC_STARTED);
        return null;
    }

    public static Date getStopped(Context ctx) throws ContextException {
        if (ctx!=null)
            return (Date)ctx.getValue(EXEC_STOPPED);
        return null;
    }
