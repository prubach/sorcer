...
set INST_CLASSPATH=%LIB_DIR%\sorcer\sos-env.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\commons\slf4j-api.jar;%LIB_DIR%\commons\slf4j-simple.jar;%LIB_DIR%\commons\xercesImpl.jar;%LIB_DIR%\commons\commons-io.jar
