...
set INST_CLASSPATH=%LIB_DIR%\sorcer\sos-env.jar;%LIB_DIR%\sorcer\sos-util.jar;%LIB_DIR%\commons\slf4j-api.jar;%LIB_DIR%\commons\slf4j-simple.jar;%LIB_DIR%\commons\commons-io.jar
...
rem call mvn archetype:crawl -Dcatalog=%HOMEDRIVE%%HOMEPATH%\.m2\archetype-catalog.xml
popd
