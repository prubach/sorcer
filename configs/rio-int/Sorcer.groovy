...
class SorcerPlatformConfig {
    ...
    def getPlatformCapabilityConfigs() {
        ...
        File sorcerLibDir = new File(System.getProperty("SORCER_HOME")+File.separator+"lib"+File.separator+"sorcer"+File.separator+"lib")
        ...
        File commonLibDir = new File(System.getProperty("SORCER_HOME")+File.separator+"lib"+File.separator+"common")
        if(commonLibDir.exists()) {
            File jar = new File(commonLibDir, "je-3.3.93.jar")
            if(jar.exists()) {
